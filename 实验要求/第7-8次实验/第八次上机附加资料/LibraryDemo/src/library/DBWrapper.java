...
public class DBWrapper {
	 ...
	 */
	private DBWrapper() throws Exception {
	...
	private DBWrapper(String inUrl, String inJdbcClassName, String inUserName,
	...
	/**
	 * connectAsDefaultLibrary() Create a connection to the library using
	...
	/**
	 * Statement getStmt() Sets up auto/manual commit & isolation level
	 * 
	...
	/**
	 * int runUpdate() Executes an update and returns true of successfully
	 * executed.
	 * 
	 * @param String
	 *            containing a SQL statement
	...
	/**
	 * boolean runChainedUpdate() Executes a chained mode update transaction.
	 * 
	 * @param String
