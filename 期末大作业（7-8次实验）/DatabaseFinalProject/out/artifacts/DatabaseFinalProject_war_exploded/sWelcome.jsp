...
<div class="main">
    <div>
        <form id="f1" name="f1" method="post" action="sinsert.jsp">
        ...
        <br/>
        <form id="f2" name="f2" method="post" action="sdelete.jsp">
        ...
        <br/>
        <form id="f4" name="f4" method="post" action="supdate.jsp">
        ...
        <br/>
        <form id="f3" name="f3" method="post" action="squery.jsp">
    ...
    <div class="ckeck-bg">
        <div class="checkbox-form">
            <div class="check-left">
                <form>
                    <input type="submit" name="bwback" value="Back" onclick="window.location='staff.jsp';return false;">
                </form>
            </div>
