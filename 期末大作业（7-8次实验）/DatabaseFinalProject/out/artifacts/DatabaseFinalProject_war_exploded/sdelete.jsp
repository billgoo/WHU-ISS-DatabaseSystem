...
<div class="main">
    ...
    <%
        ...
        String s_tableName = request.getParameter("deleteName");
        String s_condition = request.getParameter("deleteCondition");
        String sql0 = "select*from "+s_tableName;
        String sql = "delete from " + s_tableName + " where " + s_condition;
